    ...
    <main className="bg-gradient-to-tr from-gray-400 to-white">
      ...
      <div className="max-w-5xl mx-auto py-6 md:my-12 relative px-4 bg-gradient-to-tr from-white to-gray-400">
        <div className="flex items-center justify-center">
          <div className="mx-auto md:w-auto md:flex md:items-center md:justify-center md:flex-wrap grid grid-cols-2
      ...
      <section className="py-8 lg:py-12 px-4 ">
        <div className="max-w-7xl mx-auto flex justify-center flex-col">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-blue-800 ">Featured listings</h2>
          ...
          <div className="text-center mt-8 flex justify-center">
            <Link href="/listings" className="border-2 border-blue-700 bg-blue-700 font-bold rounded-lg text-lg no-underline 
      ...
      <section className="py-16 px-4 space-y-16">
        <div className="relative max-w-7xl mx-auto space-y-8">
          <div className="space-y-4 flex flex-col">
            <h2 className="text-2xl md:text-3xl font-bold text-blue-800 self-start">Latest listings</h2>
            <p className="text-lg md:text-xl max-w-4xl opacity-50 self-start">Here we show listings that have been posted in the last 2 hours</p>
            <div>
              OVDE TREBA DA IDU NAJNOVIJE OBJAVE ZA OGLASE
            </div>
          </div>
        </div>
      </section>
